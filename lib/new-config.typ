...
#let config(
  ...
  outline-indent: true,
  outline-line-fill-fill: colors.titlegold,
  ...
  // dnd-area
  area-text-fill: colors.titlered,
  ...
  (
    ...
    headers: (
      ...
      "4": (
        fill: headers-level-4,
        line-fill: headers-level-4-line,
    ...
    table: (
      ...
      header: (
        ...
        header: table-header-fill,
      ),
      body: (
        font: table-body-font,
        size: table-body-size,
        body: table-body-fill,
      ),
      cell: (

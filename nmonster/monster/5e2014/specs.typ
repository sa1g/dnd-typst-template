...
#let render-trait-if-not-none(self, name, body) = {
  ...
  return [#text(fill: self.fill.monster.title, weight: self.font.monster.title.weight, transl(name, t: sing-or-plur)): #body.proc #linebreak()]
}

#let render-specs(self, body) = [
